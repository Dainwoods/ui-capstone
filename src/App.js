	...
	constructor(props) {
		...
		this.state = {
		  ...
		  movieList: [
				...
				{ name: "My Neighboor Totoro", index: 14, genre: "Fantasy", director: "Hayao Miyazaki", year: 1988, pic: './images/totoro.jpg', favorite: './images/stargrey.png', storePage: 'https://ghiblicollection.com/product/my-neighbor-totoro-30th-anniversary-edition?product_id=6931',
